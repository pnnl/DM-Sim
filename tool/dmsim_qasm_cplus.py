...
# Version 2.3
# ---------------------------------------------------------------------------
# File: dmsim_qasm_cplus.py
# Translate OpenQASM assembly code to DMSim C++ code
# ---------------------------------------------------------------------------
...
dmfile.write("#include <stdio.h>\n")
dmfile.write('#include "util_cpu.h"\n')
dmfile.write('#include "dmsim_cpu_omp.hpp"\n')
#dmfile.write('#include "dmsim_nvgpu_omp.cuh"\n')

dmfile.write('//Use the DMSim namespace to enable C++/CUDA APIs\n')
dmfile.write('using namespace DMSim;\n\n')
...
dmfile.write('\tsim.sim();\n')
dmfile.write('\tauto* res = sim.measure(5);\n')
dmfile.write('\tprint_measurement(res, n_qubits, 5);\n')
dmfile.write('\tdelete res; \n')
dmfile.write('\treturn 0;\n}\n')
dmfile.close()

...
@Microsoft_Quantum_Samples_Chemistry_SimpleVQE_GetEnergyHydrogenVQE = alias double (double, double, double), double (double, double, double)* @Microsoft__Quantum__Samples__Chemistry__SimpleVQE__GetEnergyHydrogenVQE__body
...
define double @Microsoft__Quantum__Samples__Chemistry__SimpleVQE__GetEnergyHydrogenVQE__body(double %theta1, double %theta2, double %theta3) #0 {
entry:
  ...
  store double %theta1, double* %133
  ...
  store double %theta2, double* %145
  ...
  store double %theta3, double* %157
